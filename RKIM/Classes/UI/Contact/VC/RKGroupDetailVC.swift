...
//            }
    ...
    func takeAction(_ userId: String) {
        ...
        if action == .reOwner {
            RKIMManager.share.updateGroupInfo(groupId: groupID, groupAvatar: "https://img0.baidu.com/it/u=2381979250,1530647734&fm=253&fmt=auto&app=138&f=JPEG?w=708&h=500", ownerId: userId) { isSuccess, errorMessage, result in
                if isSuccess {
